...
def train(input_batch, target_batch, encoder, decoder, encoder_optimizer, decoder_optimizer, criterion, max_length=20):
    loss = 0
...
def trainIters(pairs, input_lang, output_lang, encoder, decoder, n_iters, print_every=100, plot_every=1000, learning_rate=0.01, batch_size=10):
    start = time.time()
    plot_losses = []
    ...
    training_pairs = [variablesFromPair(random.choice(pairs), input_lang, output_lang) for i in range(n_iters*batch_size)]
